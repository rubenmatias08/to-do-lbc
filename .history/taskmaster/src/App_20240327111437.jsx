...
//Para adicionar uma tarefa , verifica se o valor de "newTask" não está vazio e adiciona o valor a "tasks", dando-lhe 
  const addTask = () => {
    if (newTask.trim() !== '') {
      setTasks([...tasks, { id: Math.floor(Math.random), text: newTask, completed: false }]);
      setNewTask('');
    }
  };
